...
download_v2ray() {
  # 如果当前没有全局代理，下载速度会很慢，这里使用github.91chi.fun网站对下载进行加速，如果后期下载失败，可以自定义修改不同的加速地址。
  DOWNLOAD_LINK="https://github.91chi.fun/https://github.com/v2fly/v2ray-core/releases/download/$RELEASE_VERSION/v2ray-linux-$MACHINE.zip"
